function [NS,ANSE,KGE,NS_radQ,X,WW,Qsim]=cal_MILc_WEB_2L_snow_IE_h(data,X_ini,Ab,dir,name,name_suff,FIG)
NPAR=10;
...
X=convert_adim(RES);
[NS,ANSE,KGE,NS_radQ,Qsim,WW]= MILc_WEB_2L_snow_IE_h(data,X,Ab,FIG,dir,name,name_suff);

%---------------------------------------------------------------------------------
function [err]=calibOK(X_0,data,Ab,dir,name,name_suff)

X=convert_adim(X_0);
[NS,ANSE,KGE,NS_radQ]=MILc_WEB_2L_snow_IE_h(data,X,Ab,0,dir,name,name_suff);
err=1-KGE;
save X_PAR
