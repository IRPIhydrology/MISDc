%-----------------------------------------------------------------------------------------------
%   MISDc rainfall-runoff model (lumped version, hourly)
%------------------------------------------------------------------------------------------------

function [NS,ANSE,KGE,NS_radQ,Qsim,WW,WW2]=MISDc_WEB_2L_snow_IE_h(DPEQ,PAR,Ab,FIG,dir,name,name_suff)
